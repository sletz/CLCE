...
;;  07-07-04 Utilisation du package MidiShare, type remplacé par evtype, val remplacé var valint
;;
;;
;;/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
;;\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
...
;;...................................................................: midi-set-field
(defmethod midi-set-field ((e t) (field integer) (value t))
  (midisetfield e field value))
...
;;...................................................................: midi-add-field
(defmethod midi-add-field ((e t) (value t))
  (midiaddfield e value))
...
;;...................................................................: midi-write-sync
(defmethod midi-write-sync ((adrMem t) (value t))
  (MidiWriteSync adrMem value))
...
;;...................................................................: ctrl-change
(defun ctrl-change (&key (date 0)(ctrl 7)(value 127)(chan 0)(port 0) &aux e)
...
;;...................................................................: ctrl14b
(defun ctrl14b (&key (date 0)(ctrl 7)(value 127)(chan 0)(port 0) &aux e)
  "create a control change event"
...
(defun non-reg-param (&key (date 0)(param 0)(value 0)(chan 0)(port 0) &aux e)
...
;;...................................................................: registred parameter
(defun reg-param (&key (date 0)(param 0)(value 0)(chan 0)(port 0) &aux e)
...
;;...................................................................: stream
(defun streamint (&key (date 0)(fields ())(port 0) &aux e)
...
;;========================================================================================
(defun is-note-p (e) (eq (evtype e) typenote))

(defun is-key-p (e) (<= (evtype e) typeKeyPress))

(defun is-keystart-p (e) (and (eq (evtype e) typekeyon) (> (vel e) 0)))

(defun is-keyend-p (e) (or (eq (evtype e) typekeyoff) 
                           (and (eq (evtype e) typekeyon) (= (vel e) 0))))

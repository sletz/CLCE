...
;;; 22-09-08 Rename val to valint to avoit symbols conflict
;;; 23-09-08 Export midi-ev-ptr, midi-seq-ptr, midishare-framework, add add-startup-action, add-quit-action
;;; 20-09-10 Correct text function (use of code-char instead of character)
...
(defpackage :midishare
  ...
  (:export :typenote :typekeyon :typekeyoff :typekeypress
           ...
           :subframes :valint :pgm :bend :clk :song :fields :text :fmsg
           ...
           :midi-ev-ptr :midi-seq-ptr
           :add-startup-action :add-quit-action :midishare-framework
           ;; added api
...
(cl:progn
 ...
 (cffi:defcfun ("MidiDTask" midi-dtask) midi-ev-ptr (routine task-ptr) (date :long) (refnum :short) (a1 :long) (a2 :long) (a3 :long))
